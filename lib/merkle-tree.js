...
class MerkleTreeBatch {
  ...
  signable () {
    return this.tree.logic.signable()
  }

  signedBy (verificationInfo) {
    return this.tree.logic.signedBy(verificationInfo)
  }
...
module.exports = class MerkleTree extends Flushable {
  constructor (storage, roots, fork, opts = {}) {
    ...
    this.logic = opts.logic ? opts.logic(this) : new HypercoreLogic(this)
    this.fork = fork
    this.roots = roots
  ...
  signable () {
    return this.logic.signable()
  }

  signedBy (verificationInfo) {
    return this.signature !== null && this.crypto.verify(this.signable(), this.signature, verificationInfo)
  }
  ...
  static async open (storage, opts = {}) {
    ...
    return new MerkleTree(storage, roots, opts.fork || 0, opts.crypto)
  }
}
