...
class MerkleTreeBatch {
  ...
  signable () {
    return this.tree.logic.signable(this)
  }

  signedBy (verificationInfo) {
    return this.tree.logic.signedBy(this, verificationInfo)
  }
...
module.exports = class MerkleTree extends Flushable {
  ...
  signable () {
    return this.logic.signable(this)
  }

  signedBy (verificationInfo) {
    return this.logic.signedBy(this, verificationInfo)
  }
