...
module.exports = class Core {
  ...
  static async resume (oplogFile, treeFile, bitfieldFile, dataFile, opts) {
    ...
    if (!header || overwrite === true) {
      ...
      const keyPair = opts.keyPair ? { type: 'Ed25519', ...opts.keyPair } : { type: 'Ed25519', ...crypto.keyPair() }
    ...
    const sign = opts.sign || (header.keyPair.secretKey ? this.createSigner(crypto, header.keyPair) : null)
