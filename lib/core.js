...
const treeCrypto = require('./crypto')
...
module.exports = class Core {
  ...
  static async resume (oplogFile, treeFile, bitfieldFile, dataFile, opts) {
    ...
    let crypto = opts.crypto || hypercoreCrypto

    if (!legacy) {
      crypto = { ...crypto, ...treeCrypto }
    }
    ...
    return new this(header, crypto, oplog, tree, blocks, bitfield, auth, legacy, opts.onupdate || noop)
  }
