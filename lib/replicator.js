...
class RequestPool {
  ...
  async _onfork (proof, peer) {
    ...
    if (this.unforking) {
      ...
      const verified = reorg.signedBy(this.core.verificationInfo(reorg.length))
...
module.exports = class Replicator {
  ...
  joinProtocol (protocol) {
    protocol.registerPeer(this.core.key, this.core.discoveryKey, this, new RemoteState(this.core))
  }
...
async function verifyAndWrite (core, response, peer) {
  ...
  if (batch.upgraded && !batch.signedBy(core.verificationInfo(batch.length))) {
