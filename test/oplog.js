...
test('oplog', async function (t) {
  await t.test('oplog - reset storage', async function (t) {
  ...
  await t.test('oplog - basic append', async function (t) {
  ...
  await t.test('oplog - custom encoding', async function (t) {
    const storage = testStorage()
  ...
  await t.test('oplog - alternating header writes', async function (t) {
    const storage = testStorage()
  ...
  await t.test('oplog - one fully-corrupted header', async function (t) {
    const storage = testStorage()
  ...
  await t.test('oplog - header invalid checksum', async function (t) {
    const storage = testStorage()
  ...
  await t.test('oplog - malformed log entry gets overwritten', async function (t) {
  ...
  await t.test('oplog - log not truncated when header write fails', async function (t) {
  ...
  await t.test('oplog - multi append', async function (t) {
    const storage = testStorage()
  ...
  await t.test('oplog - multi append is atomic', async function (t) {
    const storage = testStorage()
